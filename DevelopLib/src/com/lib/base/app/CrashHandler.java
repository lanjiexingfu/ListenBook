...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public void init(Context context, String appName) {
        mContext = context;
        path = "/data/data/" + context.getPackageName() + File.separator + appName + File.separator + "crash" + File.separator;
     ...
     * @throws
     * @Title: sendLog
     * @Description: 必须重写sendLog（）才能生效
     */
    public void sendLog(String fileName) {
        // 发送数据 用户自定义实现
