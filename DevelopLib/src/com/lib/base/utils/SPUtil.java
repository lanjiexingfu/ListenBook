 ...
 * @author BaoHang
 */
public class SPUtil extends Basic {
    ...
    public static <T> boolean saveObjectToShare(String key, T t) {
        return saveObjectToShare(PreferenceName, key, t);
    }
     ...
     * @return
     */
    public static <T> boolean saveObjectToShare(String name, String key, T t) {
        try {
    ...
    public static <T> T getObjectFromShare(String key) {
        return getObjectFromShare(PreferenceName, key);
    }
    ...
    public static <T> T getObjectFromShare(String name, String key) {
        try {
            SharedPreferences sp = getAppContext().getSharedPreferences(name, Context.MODE_PRIVATE);
    ...
    public static void saveString(String key, String value) {
        SharedPreferences sp = getAppContext().getSharedPreferences(PreferenceName, Context.MODE_PRIVATE);
        Editor editor = sp.edit();
    ...
    public static String getString(String key, String defaultStr) {
        SharedPreferences sp = getAppContext().getSharedPreferences(PreferenceName, Context.MODE_PRIVATE);
        return sp.getString(key, defaultStr == null ? "" : defaultStr.trim());
    }
