...
import com.lib.base.app.handler.IHandler;
import com.lib.base.app.handler.SimpleHandler;
...
public class HandlerUtil {
    ...
    public static <T extends IHandler> SimpleHandler<T> newUIHandlerInstance(T t) {
        return new SimpleHandler<T>(t, Looper.getMainLooper(), SimpleHandler.HandlerType.UI);
    }
    ...
    public static <T extends IHandler> SimpleHandler<T> newBackProcessHandlerInstance(T t) {
        return new SimpleHandler<T>(t, getBackGroundLooper(t), SimpleHandler.HandlerType.BackProcess);
    }
    ...
    public static <T extends IHandler> SimpleHandler<T> newCustomUIHandlerInstance(T t) {
        return new SimpleHandler<T>(t, Looper.getMainLooper(), SimpleHandler.HandlerType.CustomUI);
    }
    ...
    public static <T extends IHandler> SimpleHandler<T> newCustomUIHandlerInstance(T t, int customHandlerType) {
        return new SimpleHandler<T>(t, Looper.getMainLooper(), SimpleHandler.HandlerType.CustomUI, customHandlerType);
    }
    ...
    public static <T extends IHandler> SimpleHandler<T> newCustomBackgroundHandlerInstance(T t) {
        return new SimpleHandler<T>(t, getBackGroundLooper(t), SimpleHandler.HandlerType.CustomBackGround);
    }
    ...
    public static <T extends IHandler> SimpleHandler<T> newCustomBackgroundHandlerInstance(T t, int customHandlerType) {
        return new SimpleHandler<T>(t, getBackGroundLooper(t), SimpleHandler.HandlerType.CustomBackGround, customHandlerType);
    }
