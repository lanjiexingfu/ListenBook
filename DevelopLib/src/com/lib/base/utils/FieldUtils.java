...
import com.lib.base.annotation.sqlite.Id;
import com.lib.base.annotation.sqlite.ManyToOne;
import com.lib.base.annotation.sqlite.OneToMany;
import com.lib.base.annotation.sqlite.Property;
import com.lib.base.annotation.sqlite.Transient;
...
public class FieldUtils {
    ...
    public static Method getFieldGetMethod(Class<?> clazz, String fieldName) {
        String mn = "getInstance" + fieldName.substring(0, 1).toUpperCase() + fieldName.substring(1);
        try {
            return clazz.getDeclaredMethod(mn);
        } catch (NoSuchMethodException e) {
            e.printStackTrace();
