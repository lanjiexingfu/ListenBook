package com.lib.ext.widget.parallaxheaderviewpager.slidingTab;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private int dataDrawableId;
    private int progressDrawableId;
    private int paymentDrawableId;
    ...
    public void setDrawableLeft(int dataDrawableId,int progressDrawableId,int paymentDrawableId){
        this.dataDrawableId = dataDrawableId;
        this.progressDrawableId = progressDrawableId;
        this.paymentDrawableId = paymentDrawableId;
    }
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            switch (i){
                ...
                case 0:
                    drawable  = getResources().getDrawable(this.dataDrawableId);
                    drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
                    tabTitleView.setCompoundDrawables(drawable,null,null,null);
                    break;
                case 1:
                    drawable= getResources().getDrawable(this.progressDrawableId);
                    drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
                    tabTitleView.setCompoundDrawables(drawable,null,null,null);
                    break;
                case 2:
                    drawable= getResources().getDrawable(this.paymentDrawableId);
                    drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
                    tabTitleView.setCompoundDrawables(drawable,null,null,null);
                    break;
