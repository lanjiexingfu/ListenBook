...
import com.lib.ab.model.AbAppProcessInfo;
import com.lib.ab.model.AbCPUInfo;
import com.lib.ab.model.AbProcessInfo;
import com.lib.ab.model.AbPsRow;
...
public class AbAppUtil {
    ...
    public static void killProcesses(Context context, int pid, String processName) {
    	...
    	DLog.d(AbAppUtil.class.getSimpleName(), "#kill -9 "+pid);*/
    ...
    public static AbProcessInfo getMemInfo(String processName) {
        ...
        for (Iterator<String[]> iterator = mProcessList.iterator(); iterator.hasNext(); ) {
            ...
            //DLog.d(AbAppUtil.class.getSimpleName(), "##"+item[9]+",NAME:"+processNameTemp);
            if (processNameTemp != null && processNameTemp.equals(processName)) {
                //DLog.d(AbAppUtil.class.getSimpleName(), "##"+item[9]+","+process.memory);
                //Process ID
        ...
        if (process.memory == 0) {
            DLog.d(AbAppUtil.class.getSimpleName(), "##" + processName + ",top -n 1未找到");
        }
        return process;
    }
    ...
    public static AbProcessInfo getMemInfo(int pid) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            //DLog.d(AbAppUtil.class.getSimpleName(), "##"+item[9]+",PID:"+tempPid);
    ...
    public static String runCommand(String[] command, String workdirectory) {
        String result = "";
        DLog.d(AbAppUtil.class.getSimpleName(), "#" + command);
        try {
    ...
    public static List<String[]> parseProcessRunningInfo(String info) {
        ...
        for (int i = 0; i < rows.length; i++) {
            tempString = rows[i];
            //DLog.d(AbAppUtil.class.getSimpleName(), tempString);
            if (tempString.indexOf("PID") == -1) {
                if (bIsProcInfo == true) {
                    ...
                    if (columns.length == Length_ProcStat) {
                        ...
                        //DLog.d(AbAppUtil.class.getSimpleName(), "#"+columns[9]+",PID:"+columns[0]);
    ...
    public static long getTotalMemory(Context context) {
        ...
        try {
            ...
            for (String str : strs) {
                DLog.d(AbAppUtil.class.getSimpleName(), str + "\t");
            }
            //获得系统总内存，单位KB  
