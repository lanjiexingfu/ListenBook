...
import com.lib.base.bitmap.core.BitmapCache;
import com.lib.base.bitmap.core.BitmapDisplayConfig;
import com.lib.base.bitmap.core.BitmapProcess;
import com.lib.base.bitmap.display.Displayer;
import com.lib.base.bitmap.display.SimpleDisplayer;
import com.lib.base.bitmap.download.Downloader;
import com.lib.base.bitmap.download.SimpleDownloader;
import com.lib.base.core.AsyncTask;
...
public class FinalBitmap {
    ...
    ////////////////////////// config method start////////////////////////////////////
    private FinalBitmap(Context context) {//默认开启硬盘缓存缓存
        mContext = context;
        mConfig = new FinalBitmapConfig(context);
        configDiskCachePath(CommonUtils.getDiskCacheDir(context, "waitToChange").getAbsolutePath());//配置缓存路径
        configDisplayer(new SimpleDisplayer());//配置显示器
        configDownloader(new SimpleDownloader());//配置下载器
    }
    ...
    public void clearCache() {
        new CacheExecutorTask().execute(CacheExecutorTask.MESSAGE_CLEAR);
    }
    ...
    public void clearCache(String key) {
        new CacheExecutorTask().execute(CacheExecutorTask.MESSAGE_CLEAR_KEY, key);
    }
    ...
    public void clearDiskCache() {
        new CacheExecutorTask().execute(CacheExecutorTask.MESSAGE_CLEAR_DISK);
    }
    ...
    public void clearDiskCache(String key) {
        new CacheExecutorTask().execute(CacheExecutorTask.MESSAGE_CLEAR_KEY_IN_DISK, key);
    }
    ...
    public void closeCache() {
        new CacheExecutorTask().execute(CacheExecutorTask.MESSAGE_CLOSE);
    }
    ...
    private class CacheExecutorTask extends AsyncTask<Object, Void, Void> {
