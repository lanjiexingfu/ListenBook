package com.lib.ext.widget.parallaxheaderviewpager;
...
public class CustomSlidingTabIndicator extends HorizontalScrollView {
    private static final String TAG = "CustomTabSlidingIndicator";
    ...
    @DrawableRes
    private int mTabBackgroundResId = R.drawable.sliding_bar_bg;
    ...
    private void updateTabStyles() {
        ...
        if (mTabBackgroundResId != R.drawable.sliding_bar_bg) {
            return;
        }
