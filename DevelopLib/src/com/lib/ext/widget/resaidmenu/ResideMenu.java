...
public class ResideMenu extends FrameLayout {
    ...
    public void setLeftContent(Fragment fragment) {
        activity.getSupportFragmentManager().beginTransaction().replace(R.id.layout_left_menu, fragment).commitAllowingStateLoss();
    }

    public void setRightContent(Fragment fragment) {
        activity.getSupportFragmentManager().beginTransaction().replace(R.id.layout_right_menu, fragment).commitAllowingStateLoss();
    }
