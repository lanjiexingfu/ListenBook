...
import com.lib.base.db.sqlite.CursorUtils;
import com.lib.base.db.sqlite.DbModel;
import com.lib.base.db.sqlite.OneToManyLazyLoader;
import com.lib.base.db.sqlite.SqlBuilder;
import com.lib.base.db.sqlite.SqlInfo;
import com.lib.base.db.table.KeyValue;
import com.lib.base.db.table.ManyToOne;
import com.lib.base.db.table.OneToMany;
import com.lib.base.db.table.TableInfo;
import com.lib.base.exception.DbException;
            ...
            try {
                ...
                for (ManyToOne many : manys) {
                    ...
                    if (id != null) {
                        ...
                        if (isFind) {
                            @SuppressWarnings("unchecked") T manyEntity = (T) findById(Integer.valueOf(id.toString()), many.getDataType());
                            if (manyEntity != null) {
