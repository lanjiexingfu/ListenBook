 ...
 */
package com.lib.base.bitmap.core;

import java.io.File;
import java.io.IOException;
import java.nio.ByteBuffer;

import com.lib.base.bitmap.core.BytesBufferPool.BytesBuffer;
import com.lib.base.bitmap.core.DiskCache.LookupRequest;
...
public class BitmapCache {
    ...
    */
    ...
    public void addToDiskCache(String url, byte[] data) {
        ...
        //Add to disk cache
        byte[] key = CommonUtils.makeKey(url);
        long cacheKey = CommonUtils.crc64Long(key);
    ...
    public boolean getImageData(String url, BytesBuffer buffer){
        ...
        try {
            ...
            if (CommonUtils.isSameKey(key, request.buffer)) {
