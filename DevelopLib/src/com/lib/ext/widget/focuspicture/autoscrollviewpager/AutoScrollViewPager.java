...
public class AutoScrollViewPager extends ViewPager {
    ...
    public void setAdapter(PagerAdapter adapter) {
        super.setAdapter(new InfiniteLoopViewPagerAdapter(adapter));
        int startItem = getAdapter().getCount() / 2;
        startItem -= startItem % adapter.getCount();
    ...
    public void scrollOnce() {
        InfiniteLoopViewPagerAdapter adapter = (InfiniteLoopViewPagerAdapter) getAdapter();
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (slideBorderMode == SLIDE_BORDER_MODE_TO_PARENT || slideBorderMode == SLIDE_BORDER_MODE_CYCLE) {
            ...
            if (ev.getAction() == MotionEvent.ACTION_DOWN) {
                 ...
                 * one.
                 */
                if ((currentItem == 0 && downX <= touchX - 50) || (currentItem == pageCount - 1 && downX >= touchX + 50)) {
...
//                            setCurrentItem(pageCount - currentItem - 1, isBorderAnimation);
    ...
    /**
     * getInstance auto scroll time in milliseconds, default is {@link #DEFAULT_INTERVAL}
     *
     * @return the interval
     */
    ...
    /**
     * getInstance auto scroll direction
     *
    ...
    /**
     * getInstance how to process when sliding at the last or first item
     *
